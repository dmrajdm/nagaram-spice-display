        ...
        <CarouselContent>
          {heroImages.map((image, index) => (
            <CarouselItem key={index} className="w-full h-full relative">
              ...
              <div className="relative flex flex-col items-center justify-center w-full h-full text-center px-4 space-y-4">
                <div className="max-w-3xl mx-auto">
                  ...
                  <div className="flex flex-wrap gap-4 justify-center">
                    <a href="#products"
                      className="bg-spice-red hover:bg-spice-red/90 text-white px-6 py-2 rounded-md font-medium transition-colors w-full sm:w-auto">
                      Explore Our Spices
                    </a>
                    <a href="#contact"
                      className="bg-spice-red hover:bg-spice-red/90 text-white px-6 py-2 rounded-md font-medium transition-colors w-full sm:w-auto">
